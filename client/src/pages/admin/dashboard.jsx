                    ...
                    <div className="flex m-auto gap-4 lg:gap-8 overflow-y-hidden w-full h-[calc(88vh)]">
                        ...
                        <div className="fixed bottom-3 right-3">
                            ...
                            <button
                                ...
                                className="mt-4 flex items-center justify-center w-[4rem] h-[4rem] text-white rounded-full bg-[color:#B106CD] hover:bg-[color:#B106CD] hover:scale-105 shadow-lg cursor-pointer transition-all ease-in-out focus:outline-none"
                                title="Create Events"
                            >
