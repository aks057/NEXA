                ...
                <div className="flex flex-col gap-y-3 sm:flex-row sm:gap-y-0 justify-between items-center mb-4">
                        ...
                        <button
                            className={`px-4 py-2 rounded ${
                                showChecklist
                                    ...
                                    : "bg-[color:#B106CD] text-white hover:bg-[color:#B106CD]"
                            }`}
                    ...
                    <div>
                        <input
                            ...
                            className="px-[3%] py-1 border border-gray-400 rounded-md focus:border-[color:#B106CD] focus:outline-none focus:ring-1 focus:ring-[color:#B106CD]"
                        />
                    </div>
                </div>
                                            ...
                                            <td className="p-2 border border-gray-300 text-center w-1/4">
                                                ...
                                                >
                                                    <div className="relative">
                                                        ...
                                                        />
                                                        <div
                                                            className={`bg-white border border-[color:#B106CD] rounded-md shadow-sm w-6 h-6 flex items-center justify-center mr-2 ${
                                                                user.checked
                                                                    ? "ring-1 ring-[color:#B106CD]"
                                                                    : ""
                                                            }`}
                                                        >
                                                            {user.checked && (
                                                                <FaCheck className="text-[color:#B106CD]" />
                                                            )}
                                                        </div>
                                                    </div>
                ...
                {showChecklist ? (
                    <center>
                        <button
                            ...
                            className="bg-[color:#B106CD] hover:bg-[color:#B106CD] mt-3 text-white py-3 px-[15%] rounded-md transition duration-300 ease-in-out"
                        >
                            Submit list
                        </button>
                    </center>
