    ...
    return (
        <li className="mr-4 cursor-pointer relative" ref={dropdownRef}>
            <button
                ...
                className="flex items-center justify-center bg-[color:#B106CD] text-white text-sm font-medium rounded-md w-28 h-10 focus:outline-none"
            >
            ...
            {showDropdown && (
                <div className="absolute right-0 bg-white rounded-md overflow-hidden shadow-lg z-10">
                    ...
                    <div
                        ...
                        className="py-4 group hover:bg-[color:#B106CD] transition-all ease-in-out"
                    >
